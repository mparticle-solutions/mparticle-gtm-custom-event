...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "mParticle - Event - Custom Template",
  "catagories": [
    "MARKETING", 
    "ANALYTICS", 
    "PERSONALIZATION"
  ...
  "description": "This template allows for the configuration and sending of a mParticle custom event. This tag will only work after the successful initialization of the mParticle SDK.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    ...
    "help": "Please enter the desired event name for this custom event.",
    "valueValidators": [
      {
        "type": "NON_EMPTY"
      }
  ...
  },
  {
    ...
    "help": "Please enter any desired custom attributes to be mapped onto this event here."
  },
  {
    "type": "SIMPLE_TABLE",
    "name": "customFlags",
...
let attributes = populateAttributes(data.customAttributes); 
let flags = populateAttributes(data.customFlags); 


//callInWindow('mParticle.ready', function() { 
  callInWindow('mParticle.logEvent', eventName, eventType, attributes, flags);
//}); 
...
scenarios:
- name: Event logged in window
  code: "const log = require('logToConsole');\nconst mockData = {\n  eventName: \"\
    test event name\", \n  eventType: 8,\n  customFlags: [\n    {\n     \"key\": \"\
    CF Key\", \n     \"value\": \"CF Value\", \n    }\n  ],\n  customAttributes: [\n\
    \    {\n      \"key\": \"CA Key\", \n      \"value\": \"CA Value\",\n    }\n \
    \ ],\n};\n\nmock('callInWindow', function(method, fun) {\n  if (method == \"mParticle.Ready\"\
    ) {\n    log(fun); \n    return fun; \n  }\n});\n     \nconst transformedData\
    \ = {\n  eventName: \"test event name\", \n  eventType: 8,\n  attributes: {\n\
    \    \"CA Key\": \"CA Value\"\n  }, \n  flags: {\n    \"CF Key\": \"CF Value\"\
    \n  }\n};\n// Call runCode to run the template's code.\nrunCode(mockData);\n\n\
    // Verify that the tag finished successfully.\nassertApi('callInWindow').wasCalledWith('mParticle.logEvent',\
    \ transformedData.eventName, transformedData.eventType, transformedData.attributes,\
...
Created on 8/7/2023, 4:03:12 PM
